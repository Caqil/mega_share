...
class CoreModule extends DIModule {
  static Future<void> register(GetIt sl) async {
    ...
    // Device Info Helper
    sl.registerLazySingleton<DeviceInfoHelper>(
...
class ConnectionModule extends DIModule {
  static Future<void> register(GetIt sl) async {
    ...
    sl.registerLazySingleton(
      () => GetConnectionInfoUseCase(repository: sl()),
    );
...
class FileManagementModule extends DIModule {
  static Future<void> register(GetIt sl) async {
    ...
    // Use Cases
    sl.registerLazySingleton(
      () => GetStorageInfoUseCase(repository: sl()),
    );
